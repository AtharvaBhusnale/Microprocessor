...
;OUTPUT
;(base) student@ioe-hwlab:~$ nasm -f elf64 MPexp6.asm
;(base) student@ioe-hwlab:~$ ld -o prog MPexp6.o
...
;Enter 5 digit BCD number::123


;Hex Equivalent::0396A
