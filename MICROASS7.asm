...
up1:	rol bx,4		;rotate number left by four bits
...
;(base) student@ioe-hwlab:~$ nasm -f elf64 MPexp7.asm
;(base) student@ioe-hwlab:~$ ld -o prog MPexp7.o
;(base) student@ioe-hwlab:~$ ./prog

;Processor is in Protected Mode
;GDT Contents are::00094000:007F
